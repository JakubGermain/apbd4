...
namespace Exercise9_apbd.Migrations
{
    /// <inheritdoc />
    public partial class AfterModelsFix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "jkowalski@example.com", "Jan", "Kowalski" });

            migrationBuilder.InsertData(
                table: "Medicament",
                columns: new[] { "IdMedicament", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Ból głowy", "Apap" },
                    { 2, "Ból i gorączka", "Ibuprofen" }
                });
